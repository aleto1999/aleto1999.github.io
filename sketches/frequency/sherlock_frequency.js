const dots = ( d ) => {
  ...
  d.preload = function(){
    ...
    d.loadStrings('assets/the_adventures_of_sherlock_holmes_female_analysis.txt',d.setFemaleFreqs);
    d.loadStrings('assets/the_adventures_of_sherlock_holmes_male_analysis.txt',d.setMaleFreqs);
