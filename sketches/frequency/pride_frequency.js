const dots3 = ( d ) => {
  ...
  d.preload = function(){
    ...
    d.loadStrings('assets/pride_and_prejudice_female_analysis.txt',d.setFemaleFreqs);
    d.loadStrings('assets/pride_and_prejudice_male_analysis.txt',d.setMaleFreqs);
