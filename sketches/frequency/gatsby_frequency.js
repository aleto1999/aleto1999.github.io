const dots4 = ( d ) => {
  ...
  d.preload = function(){
    ...
    d.loadStrings('assets/the_great_gatsby_female_analysis.txt',d.setFemaleFreqs);
    d.loadStrings('assets/the_great_gatsby_male_analysis.txt',d.setMaleFreqs);
...
let myp5_4 = new p5(dots4, 'gatsby');
